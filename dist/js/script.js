      ...
      var Ft = function() {
        ...
        return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
          ...
          for (var M2 = function(t4, i3) {
            ...
            var E2 = void 0 === a2[o2][z2 + 1] || null === a2[o2][z2 + 1];
            if (w2.globals.isXNumeric) {
              var Y2 = w2.globals.seriesX[r2][z2 + 1];
              void 0 === w2.globals.seriesX[r2][z2 + 1] && (Y2 = w2.globals.seriesX[r2][s2 - 1]), n2 = (Y2 - w2.globals.minX) / this.xRatio;
            } else
              n2 += this.xDivision;
            if (w2.config.chart.stacked)
              ...
              u2 = this.zeroY;
            E2 ? l2 = M2(T2, u2) : (l2 = M2(a2[o2][z2 + 1], u2), "rangeArea" === i2 && (X2 = M2(y2[o2][z2 + 1], u2))), p2.push(n2), E2 && "smooth" === w2.config.stroke.curve ? f2.push(null) : f2.push(l2), b2.push(X2);
            var F2 = this.lineHelpers.calculatePoints({ series: a2, x: n2, y: l2, realIndex: r2, i: o2, j: z2, prevY: S2 }), R2 = this._createPaths({ type: i2, series: a2, i: o2, realIndex: r2, j: z2, x: n2, y: l2, y2: X2, xArrj: p2, yArrj: f2, y2Arrj: b2, linePath: C2, areaPath: L2, linePaths: c2, areaPaths: d2, seriesIndex: g2, isRangeStart: v2 });
            d2 = R2.areaPaths, c2 = R2.linePaths, L2 = R2.areaPath, C2 = R2.linePath, !this.appendPathFrom || "smooth" === w2.config.stroke.curve && "rangeArea" === i2 || (P2 += k2.line(n2, this.zeroY), I2 += k2.line(n2, this.zeroY)), this.handleNullDataPoints(a2, F2, o2, z2, r2), this._handleMarkersAndLabels({ type: i2, pointsPos: F2, i: o2, j: z2, realIndex: r2, isRangeStart: v2 });
          }
          ...
          if (Array.isArray(v2.config.stroke.curve) && (w2 = Array.isArray(x2) ? v2.config.stroke.curve[x2[a2]] : v2.config.stroke.curve[a2]), "rangeArea" === e2 && (v2.globals.hasNullValues || v2.config.forecastDataPoints.count > 0) && "smooth" === w2 && (w2 = "straight"), "smooth" === w2) {
            if ("rangeArea" === e2 ? l2.length === v2.globals.dataPoints : r2 === i2[a2].length - 2) {
              ...
              if (g2 += zt(S2), null === i2[a2][0] ? u2 = g2 : u2 += zt(S2), "rangeArea" === e2 && b2) {
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var chart = new import_apexcharts.default(document.querySelector("#chartFive"), options);
  chart.render();
})();
